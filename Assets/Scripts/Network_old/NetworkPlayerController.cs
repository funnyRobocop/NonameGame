...
namespace NonameGame
{
    public class NetworkPlayerController : NetworkBehaviour
    {
        ...
        private NetworkPlayerRagdoll _ragdoll;
        ...
        {
            _ragdoll = GetComponent<NetworkPlayerRagdoll>();
        ...
        public override void FixedUpdateNetwork()
        {
            ...
            // Записываем текущую скорость физического тела в сеть для синхронизации анимаций
            // Читаем горизонтальную скорость Rigidbody (оси X и Z)
            ...
            // Запрашиваем статус земли у контроллера Nappin
            // (Замените IsGrounded на имя переменной земли из вашего ассета, например groundCheck или isGrounded)
            if (_characterManager != null)
            {
                _netGrounded = _characterManager.isGrounded; 
            }
